...
const REAL A_CELL_RADIUS[NUM_CELL_TYPES] = { 1.5, 1.5 };
...
const REAL BASELINE_TIME_STEP_DURATION = 0.25;
...
const REAL AGENT_TRANSLATION_ROTATION_PSEUDO_TIME_STEP_DURATION = 0.0001;
const S32 AGENT_TRANSLATION_ROTATION_INTEGRATION_STEPS_PER_BASELINE_TIME_STEP = (S32) ROUND( BASELINE_TIME_STEP_DURATION / 0.0001);
...
const BOOL A_PERIODIC_DOMAIN[DIMENSION] = { false, false, false };

#define INCLUDE_DEFORMATION_HOOKS_LAW 0
#define INCLUDE_DEFORMATION_NEO_HOOKEAN 1

const REAL AGENT_DEFORMATION_INCOMPRESSIBLE_MIN_POISSONS_RATIO = 0.5 - 1e-5;
const S32 AGENT_DEFORMATION_NEWTONS_METHOD_MAX_ITERS = 100;
const REAL AGENT_DEFORMATION_NEWTONS_METHOD_EPSILON_INIT_NORM = 1e-6;
const REAL AGENT_DEFORMATION_NEWTONS_METHOD_EPSILON_E = 1e-15;
const REAL AGENT_DEFORMATION_NEWTONS_METHOD_NORM_THRESHOLD = 1e-15;
